package com.javaAdvance.sharding.generator;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        final String projectPath = "D:\\code\\GitHub\\javaAdvance\\sharding-proxy";
        ...
        dsConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://127.0.0.1:3306/db?serverTimezone=GMT%2B8")
                .setUsername("root")
                .setPassword("")
        ...
        pkConfig.setParent("com.javaAdvance.sharding")
                //dao
