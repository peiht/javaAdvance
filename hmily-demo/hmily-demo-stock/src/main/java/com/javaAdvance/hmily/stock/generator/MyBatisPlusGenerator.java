package com.javaAdvance.hmily.stock.generator;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://127.0.0.1:3308/stock?serverTimezone=GMT%2B8")
                .setUsername("root")
                .setPassword("")
        ...
        pkConfig.setParent("com.javaAdvance.hmily.stock")
                //dao
